...
function App() {
  ...
  const handleAnalysis = async (notes: string, approach: string) => {
    ...
    if (currentPatient) {
        ...
        if (currentPatient.birthDate) demos.push(`Data de Nasc.: ${new Date(currentPatient.birthDate + (currentPatient.birthDate.includes('T') ? '' : 'T12:00:00')).toLocaleDateString('pt-BR')}`);
